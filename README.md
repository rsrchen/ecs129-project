...
This program was written in Python3 and relies on [numpy](https://numpy.org/), [matplotlib](https://matplotlib.org/), and [biopython](https://biopython.org/) among other dependencies. These are listed in `requirements.txt`.
