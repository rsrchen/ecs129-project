...
This program was written in Python3 and relies on [numpy](https://numpy.org/) and [matplotlib](https://matplotlib.org/), among other dependencies. These are listed in `requirements.txt`.
